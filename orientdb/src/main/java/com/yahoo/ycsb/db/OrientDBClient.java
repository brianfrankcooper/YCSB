...
public class OrientDBClient extends DB {
  ...
  public void init() throws DBException {
    ...
    Boolean newdb =
        Boolean.parseBoolean(props.getProperty("orientdb.newdb", "false"));
    ...
    try {
      ...
      System.err
          .println("Could not initialize OrientDB connection pool for Loader: "
              + e1.toString());
      e1.printStackTrace();
      return;
    }
  ...
  public Status scan(String table, String startkey, int recordcount,
    ...
    try {
      final OIndexCursor entries =
          dictionary.getIndex().iterateEntriesMajor(startkey, true, true);
