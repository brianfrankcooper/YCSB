...
public class TarantoolClient extends DB {
  ...
  private static final Logger LOGGER =
      Logger.getLogger(TarantoolClient.class.getName());
  ...
  private HashMap<String, ByteIterator> tupleConvertFilter(List<String> input,
      Set<String> fields) {
  ...
  public Status read(String table, String key, Set<String> fields,
    ...
    try {
      ...
      response =
          this.connection.select(this.spaceNo, 0, Arrays.asList(key), 0, 1, 0);
  ...
  public Status scan(String table, String startkey, int recordcount,
    ...
    try {
      response = this.connection.select(this.spaceNo, 0,
          Arrays.asList(startkey), 0, recordcount, 6);
    } catch (TarantoolException exc) {
