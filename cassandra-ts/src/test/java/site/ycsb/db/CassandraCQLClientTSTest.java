 ...
 */
public class CassandraCQLClientTSTest {
  ...
  private CassandraCQLClientTS client;
  ...
  public void setUp() throws Exception {
    ...
    workload.init(p);
    client = new CassandraCQLClientTS();
  ...
  private void insertRow() {
    ...
    insertStmt.value(CassandraCQLClientTS.YCSB_KEY, rowKey);
  ...
  public void testRead() throws Exception {
    ...
    assertThat(strResult, hasEntry(CassandraCQLClientTS.YCSB_KEY, DEFAULT_ROW_KEY));
  ...
  public void testInsert() throws Exception {
    ...
    final Select selectStmt =
        QueryBuilder.select("field0", "field1")
            .from(TABLE)
            .where(QueryBuilder.eq(CassandraCQLClientTS.YCSB_KEY, key))
            .limit(1);
  ...
  public void testUpdate() throws Exception {
    ...
    final Select selectStmt =
        QueryBuilder.select("field0", "field1")
            .from(TABLE)
            .where(QueryBuilder.eq(CassandraCQLClientTS.YCSB_KEY, DEFAULT_ROW_KEY))
            .limit(1);
