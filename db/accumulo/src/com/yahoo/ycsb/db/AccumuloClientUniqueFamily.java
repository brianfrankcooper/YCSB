...
public class AccumuloClientUniqueFamily extends DB {
	...
	private int _scanBatchSize = 1000;
	...
	public void init() throws DBException {
		...
		_scanBatchSize=new Integer(getProperties().getProperty("cloudbase.scanBatchSize", "1000")).intValue();
	}
	...
	public int scan(String table, String startkey, int recordcount,
		...
		_scanScanner.setBatchSize(_scanBatchSize);
