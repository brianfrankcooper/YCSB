...
# Remove given folder and (re)create it.
    ...
    for workload in ${workloadFiles[*]}; do
        ...
        for i in $(seq 1 ${times}); do
            ...
            for runType in ${runTypes[*]}; do
                ...
                clearFolder ${measurementsFolder}

                progress $(( currentRun / numOfTotalBenchmarkRuns )) "$database - $(basename ${workload}) - $i/$times - $runType"
