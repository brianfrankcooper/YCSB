...
/**
 * Export measurements into a machine readable JSON Array of measurement
 * objects.
 */
public class JSONArrayMeasurementsExporter implements MeasurementsExporter {
  ...
  public JSONArrayMeasurementsExporter(final OutputStream os)
      throws IOException {
  ...
  @Override
  public void write(final String metric, final String measurement,
  ...
  @Override
  public void write(final String metric, final String measurement, final int i)
      throws IOException {
    g.writeStartObject();
    g.writeStringField("metric", metric);
    g.writeStringField("measurement", measurement);
