...
public class ExponentialGenerator extends IntegerGenerator {
  ...
  public static final String EXPONENTIAL_PERCENTILE_PROPERTY =
      "exponential.percentile";

  public static void main(final String[] args) {
    final ExponentialGenerator e = new ExponentialGenerator(90, 100);
    int j = 0;
  ...
  public ExponentialGenerator(final double percentile, final double range) {
  ...
  public long nextLong() {
    return (long) (-Math.log(Utils.random().nextDouble()) / gamma);
  }
}
