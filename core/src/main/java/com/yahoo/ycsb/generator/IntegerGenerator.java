...
public abstract class IntegerGenerator extends Generator 
{
	 ...
	 */
	protected void setLastInt(long last)
	{
		lastint=last;
	}
	...
	/**
	 * Return the previous long generated by the distribution. This call is unique to IntegerGenerator subclasses, and assumes
	 * IntegerGenerator subclasses always return longs for nextInt() (e.g. not arbitrary strings)... Yeah, perhaps that should
	 * be renamed, but keeping the impact low for now.
	 */
	public long lastInt()
	{
		return lastint;
