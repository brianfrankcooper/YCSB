...
public abstract class IntegerGenerator extends Generator {
  ...
  /**
   * Return the previous int generated by the distribution. This call is unique
   * to IntegerGenerator subclasses, and assumes IntegerGenerator subclasses
   * always return ints for nextInt() (e.g. not arbitrary strings).
   */
  public int lastInt() {
    return lastint;
  }
   ...
   */
  protected void setLastInt(final int last) {
    lastint = last;
  }
}
