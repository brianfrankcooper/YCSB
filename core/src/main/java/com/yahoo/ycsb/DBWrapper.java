...
public class DBWrapper extends DB {
  ...
  public Status delete(final String table, final String key) {
    final long ist = measurements.getIntendedtartTimeNs();
    final long st = System.nanoTime();
    final Status res = db.delete(table, key);
    final long en = System.nanoTime();
  ...
  public Status insert(final String table, final String key,
    ...
    final long ist = measurements.getIntendedtartTimeNs();
    final long st = System.nanoTime();
    final Status res = db.insert(table, key, values);
    final long en = System.nanoTime();
  ...
  public Status read(final String table, final String key,
    ...
    final long ist = measurements.getIntendedtartTimeNs();
    final long st = System.nanoTime();
    final Status res = db.read(table, key, fields, result);
    final long en = System.nanoTime();
  ...
  public Status scan(final String table, final String startkey,
    ...
    final long ist = measurements.getIntendedtartTimeNs();
    final long st = System.nanoTime();
    final Status res = db.scan(table, startkey, recordcount, fields, result);
    final long en = System.nanoTime();
  ...
  public Status update(final String table, final String key,
    ...
    final long ist = measurements.getIntendedtartTimeNs();
    final long st = System.nanoTime();
    final Status res = db.update(table, key, values);
    final long en = System.nanoTime();
