 ...
 * <UL>
 * <LI><b>fieldprefix</b>: the prefix of field in a record (default: field)
...
public class CoreWorkload extends Workload
{
	...
	/**
	 * The name of the property for the field's prefix.
	 */
	public static final String FIELD_PREFIX_PROPERTY="fieldprefix";
	/**
	 * The default prefix of a field.
	 */
	public static final String FIELD_PREFIX_PROPERTY_DEFAULT="field";
  ...
  public static final String HOTSPOT_OPN_FRACTION_DEFAULT = "0.8";
	...
	public void init(Properties p) throws WorkloadException
	{
		...
		fieldprefix=p.getProperty(FIELD_PREFIX_PROPERTY,FIELD_PREFIX_PROPERTY_DEFAULT);
	...
	HashMap<String, ByteIterator> buildUpdate() {
		...
		HashMap<String, ByteIterator> values=new HashMap<String,ByteIterator>();
		String fieldname=fieldprefix+fieldchooser.nextString();
		ByteIterator data = new RandomByteIterator(fieldlengthgenerator.nextInt());
