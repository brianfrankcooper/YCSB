...
public class InfinispanRemoteClient extends DB {
  private static final Log LOGGER =
      LogFactory.getLog(InfinispanRemoteClient.class);
  ...
  @Override
  public Status insert(String table, String recordKey,
  ...
  @Override
  public Status read(String table, String recordKey, Set<String> fields,
  ...
  @Override
  public Status update(String table, String recordKey,
      HashMap<String, ByteIterator> values) {
    String compositKey = createKey(table, recordKey);
    try {
      Map<String, String> stringValues = new HashMap<String, String>();
