...
public class HBaseClient extends com.yahoo.ycsb.DB
{
  ...
  public Status scan(String table, String startkey, int recordcount, Set<String> fields, Vector<HashMap<String,ByteIterator>> result)
  {
    ...
    //operations[0] = is_filter
    //operations[1] = compare operation
    //operations[2] = comparable value
    String[] operations = op != null ? op.split(":") : new String[0];
    ...
    if(!operations[0].equals("isFilter#true")) {
      ...
      Filter filter = new RowFilter(getCompareOperation(operations[1]), new BinaryComparator(operations[2].getBytes()));
      s.setFilter(filter);
    }
    //get results
